 ...
 * {@link android.app.Activity#onDestroy()} to avoid Context} leaks.
...
public final class Crouton {
     ...
     * @param style      The style that this
     ...
     *
     * @param activity      The
     * that represents the context in which the Crouton should exist.
     * @param text      The text you want to display.
     * @param style      The style that this
     * should be created with.
     * @param viewGroup      The
     ...
     * @param style      The style that this
     * should be created with.
     * @param viewGroupResId      The resource id of the
     * that this
     * should be added to.
     * @return The created
     *.
