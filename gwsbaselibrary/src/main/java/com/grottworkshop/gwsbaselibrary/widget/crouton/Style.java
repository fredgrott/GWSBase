...
package com.grottworkshop.gwsbaselibrary.widget.crouton;
 ...
 * Created by fgrott on 10/11/2014.
 */
public class Style {
    ...
    public static class Builder {
         ...
         *
         * @param heightDimensionResId    Resource ID of a dimension for the height of the
         *.
         * @return the .
         */
         ...
         *
         * @param widthDimensionResId    Resource ID of a dimension for the width of the
         *.
         * @return the .
         */
         ...
         *
         * @param gravity    The text's gravity as provided by
         *.
         * @return the .
         */
        ...
        /** The text size in sp.  @param textSize the text size
        ...
        /** The text shadow color resource id.  @param textShadowColorResId the text shadow color res id
        ...
        /** The text shadow radius.  @param textShadowRadius the text shadow radius
        ...
        /** The text shadow horizontal offset.  @param textShadowDx the text shadow dx
         * @return the text shadow dx
         */
        ...
        /** The text shadow vertical offset.  @param textShadowDy the text shadow dy
         * @return the text shadow dy
         */
        ...
        /** The text appearance resource id for the text.  @param textAppearanceResId the text appearance res id
        ...
        /** The {@link android.widget.ImageView.ScaleType} for the image.  @param imageScaleType the image scale type
        ...
        /** The padding for the crouton view's content in pixels.  @param padding the padding
        ...
        /** The resource id for the padding for the crouton view's content.  @param paddingResId the padding res id
         * @return the padding dimension res id
         */
        ...
        /** The file path and name of the font for the crouton view's content.  @param fontName the font name
        ...
        /** The resource id for the file path and name of the font for the crouton view's content.  @param fontNameResId the font name res id
         * @return the font name res id
         */
