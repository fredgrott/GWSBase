...
public abstract class StandOutWindow extends Service {
     ...
     *
     * <p>
     * Send  Parceleable data in a {@link Bundle} to a new or existing
    ...
    /**
     * See closeAll(Context, Class, int)}.
     *
     * @param context
     *            A Context of the application package implementing this class.
     * @param cls
    ...
    /**
     * Return the StandOutWindow#LayoutParams} for the corresponding id.
     ...
     * @return The StandOutWindow#LayoutParams} corresponding to the id.
    ...
    public PopupWindow getDropDown(final int id) {
        ...
        for (final DropDownListItem item : items) {
            ViewGroup listItem = (ViewGroup) mLayoutInflater.inflate(
                    R.layout.standout_drop_down_list_item, null);
     ...
     *         continue.
     *  updateViewLayout(int, Window, StandOutLayoutParams)
     */
     ...
     * createAndAttachView(int, ViewGroup)}. This means the returned
