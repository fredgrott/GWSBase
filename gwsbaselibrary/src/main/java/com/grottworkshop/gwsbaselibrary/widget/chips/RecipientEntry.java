...
public class RecipientEntry {
    ...
    /** Type of the destination like  Email#TYPE_HOME} */
    private final int mDestinationType;
    /**
     * Label of the destination which will be used when type was Email#TYPE_CUSTOM}.
    ...
    private static String pickDisplayName(int displayNameSource, String displayName,
                                          String destination) {
        return (displayNameSource > ContactsContract.DisplayNameSources.PHONE) ? displayName : destination;
    }
