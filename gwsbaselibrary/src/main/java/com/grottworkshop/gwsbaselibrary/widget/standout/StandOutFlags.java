...
public class StandOutFlags {
     ...
     * StandOutWindow#getHiddenIcon(int)},
     * StandOutWindow#getHiddenTitle(int)}, and
     * StandOutWindow#getHiddenMessage(int)} are implemented, and that
     ...
     * window during MotionEvent#ACTION_UP}. This the hack that allows
     ...
     *
     * <p>
     * If this flag is set, the window's  Gravity} is recommended to be
     * Gravity#TOP} | Gravity#LEFT}. If the gravity is anything
     ...
     *
     *  Window#onInterceptTouchEvent(MotionEvent)
     */
     ...
     * WindowfixCompatibility(View, int)} on the view returned by the
     * implementation.
     *
     *  Window.fixCompatibility(View, int)}
     */
     ...
     * Window.addFunctionality(View, int)} on the view returned by the
     * implementation.
     *
     *  StandOutWindow.addFunctionality(View, int)}
     */
     ...
     *
     *  Window.addFunctionality(View, int)}
     */
